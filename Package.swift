...
let package = Package(
    ...
    dependencies: [
        .package(name: "Web3", url: "https://github.com/bitmark-inc/Web3.swift.git", .exact("0.5.5")),
        ...
        .package(name: "BitmarkSDK", url: "https://github.com/bitmark-inc/bitmark-sdk-swift.git", .branch("spm"))
